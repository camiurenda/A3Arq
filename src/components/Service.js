                    ...
                    <div className="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                        <div className="service-item d-flex position-relative text-center h-100">
                            ...
                            <div className="service-text p-5">
                                ...
                                <p className="mb-4">Erat ipsum justo amet duo et elitr dolor, est duo duo eos lorem sed diam
                                    stet diam sed stet.</p>
                                <a className="btn" href="/service.html"><i className="fa fa-plus text-primary me-3"></i>Read More</a>
                            </div>
                        </div>
                    </div>
